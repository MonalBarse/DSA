 ...
 *
 * Since you know graphs, think of trees as:
 * - Connected graphs with NO CYCLES
 * - Exactly N-1 edges for N nodes
 * - Hierarchical structure (parent-child relationships)
 *
 * This file covers:
 * 1. Tree Node Structure & Basic Operations
 * 2. Tree Traversals (DFS variants + BFS)
 * 3. Tree Properties & Measurements
 * 4. Binary Tree Specific Algorithms
 * 5. Tree Construction & Manipulation
...
public class BasicsOfTrees {
    ...
    /**
     * Basic Binary Tree Node - Most common in interviews/tests
    ...
    /**
     * N-ary Tree Node - For trees where each node can have multiple children
     * Think of file systems, organization charts, etc.
     */
     ...
     * Use case: Deleting tree, calculating size/height, expression evaluation
     * Think: "Process current node AFTER its children"
     */
     ...
     * Use case: Printing tree level by level, finding shortest path in unweighted tree
     * This is your BFS knowledge applied to trees!
     */
    ...
    /**
     * LEVEL ORDER with LEVEL SEPARATION - Very common in tests!
     ...
     * This is a classic problem - understand the logic!
     */
     ...
     * BST Property: For each node, all left descendants < node < all right descendants
     */
     ...
     * Balanced: For every node, height difference between left and right subtrees ≤ 1
     */
     ...
     * Complete: All levels filled except possibly the last, and last level filled from left
     */
     ...
     * This is a classic problem - understand the pattern!
     */
     ...
     * Very common in tests - multiple variations exist
     */
    ...
    private static void findPaths(TreeNode node, List<Integer> currentPath, List<List<Integer>> paths) {
        if (node == null) return;
     ...
     * Very important concept - appears in many variations
     */
    ...
    /**
     * FLATTEN tree to linked list (right-skewed tree)
     ...
     * Convert tree to string and back - very common in tests
     */
    ...
    /**
     * TREE ITERATORS - Traverse tree using iterator pattern
     * This shows how to convert recursive traversal to iterative
     */
