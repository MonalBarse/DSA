...
/**
 * Topics covered: 1. Simple recursion 2. Recursion with memoization (top-down DP) 3. Tabulation
 * (bottom-up DP) 4. Space optimization techniques
 *
 * <p>Example problems: - Fibonacci sequence - Climbing stairs problem - Knapsack problem - Longest
 * common subsequence
 */
public class DP101_1 {
  ...
  /**
   * Simple recursive implementation of Fibonacci Time Complexity: O(2^n) - exponential Space
  ...
  /**
   * Memoized (top-down) implementation of Fibonacci Time Complexity: O(n) Space Complexity: O(n)
   */
  ...
  /**
   * Tabulated (bottom-up) implementation of Fibonacci Time Complexity: O(n) Space Complexity: O(n)
   */
  ...
  /** Space-optimized implementation of Fibonacci Time Complexity: O(n) Space Complexity: O(1) */
  ...
  /**
   * Recursive implementation of the climbing stairs problem You can climb 1 or 2 steps at a time.
   * How many ways to reach the top? Time Complexity: O(2^n) Space Complexity: O(n) - recursion
   * stack
   */
  ...
  /**
   * Memoized implementation of the climbing stairs problem Time Complexity: O(n) Space Complexity:
   * O(n)
   */
  ...
  /**
   * Tabulated implementation of the climbing stairs problem Time Complexity: O(n) Space Complexity:
   * O(n)
   */
  ...
  public int minCostClimbingStairsTabulated(int[] cost) {
    ...
    dp[n - 1] =
        cost[n - 1]; // Cost to reach the top from the last step is just the cost of that step
    for (int i = n - 2; i >= 0; i--) {
  ...
  /**
   * Recursive implementation of the 0/1 Knapsack problem Time Complexity: O(2^n) Space Complexity:
   * O(n) - recursion stack
   */
  /*
  ...
  /**
   * Memoized implementation of the 0/1 Knapsack problem Time Complexity: O(n * capacity) Space
  ...
  private int knapsackMemoizedHelper(
      int[] weights, int[] values, int capacity, int n, Integer[][] memo) {
    // Base case
    ...
    int include =
        values[n - 1]
            + knapsackMemoizedHelper(weights, values, capacity - weights[n - 1], n - 1, memo);
  ...
  /**
   * Tabulated implementation of the 0/1 Knapsack problem Time Complexity: O(n * capacity) Space
   * Complexity: O(n * capacity)
   */
  ...
  /**
   * Recursive implementation of the Longest Common Subsequence (LCS) problem Time Complexity:
   * O(2^(m+n)) Space Complexity: O(m+n) - recursion stack
   */
  ...
  public int lcsRecursive(String text1, String text2, int m, int n) {
    ...
    return Math.max(lcsRecursive(text1, text2, m - 1, n), lcsRecursive(text1, text2, m, n - 1));
  }

  /**
   * Memoized implementation of the LCS problem Time Complexity: O(m * n) Space Complexity: O(m * n)
   */
  ...
  /**
   * Tabulated implementation of the LCS problem Time Complexity: O(m * n) Space Complexity: O(m *
   * n)
   */
  ...
  public static void main(String[] args) {
    ...
    startTime = System.nanoTime();
    System.out.println(
        "Ways to climb " + stairs + " stairs (recursive): " + dp.climbStairsRecursive(stairs));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");

    startTime = System.nanoTime();
    System.out.println(
        "Ways to climb " + stairs + " stairs (memoized): " + dp.climbStairsMemoized(stairs));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");

    startTime = System.nanoTime();
    System.out.println(
        "Ways to climb " + stairs + " stairs (tabulated): " + dp.climbStairsTabulated(stairs));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");
    ...
    System.out.println(
        "Maximum value (recursive): "
            + dp.knapsackRecursive(weights, values, capacity, values.length));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");

    startTime = System.nanoTime();
    System.out.println(
        "Maximum value (memoized): "
            + dp.knapsackMemoized(weights, values, capacity, values.length));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");

    startTime = System.nanoTime();
    System.out.println(
        "Maximum value (tabulated): "
            + dp.knapsackBottomUp(weights, values, capacity, values.length));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");
    ...
    startTime = System.nanoTime();
    System.out.println(
        "LCS length (recursive): " + dp.lcsRecursive(text1, text2, text1.length(), text2.length()));
    System.out.println("Time taken: " + (System.nanoTime() - startTime) / 1000000 + " ms\n");
    ...
    System.out.println(
        "2. Define the state clearly (what each position in your array/table represents)");
    ...
    System.out.println(
        "5. Decide implementation approach (recursive with memoization or iterative with"
            + " tabulation)");
