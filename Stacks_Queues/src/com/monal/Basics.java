 ...
 * in Java
 *
 * <p>Topics Covered: 1. Stack Fundamentals (LIFO - Last In First Out) 2. Queue Fundamentals (FIFO -
 * First In First Out) 3. Implementation using Arrays and LinkedList 4. Built-in Java Collections 5.
 * Common Operations and Edge Cases 6. Real-world Applications 7. Practice Problems and Examples 8.
...
public class Basics {
  ...
  /**
   * CUSTOM STACK IMPLEMENTATION USING ARRAY Stack follows LIFO (Last In First Out) principle Think
   * of it like a stack of plates - you add/remove from the top only
   */
  ...
  /**
   * CUSTOM QUEUE IMPLEMENTATION USING ARRAY (CIRCULAR QUEUE) Queue follows FIFO (First In First
   * Out) principle Think of it like a line at a restaurant - first person in line gets served first
   */
  static class ArrayQueue<T> {
    ...
    public void enqueue(T item) {
      ...
      // Circular increment: if rear reaches the end of array, it wraps to start
      // This allows us to reuse spaces freed by dequeue operations
      // Example: capacity=4, rear=3 -> rear=(3+1)%4=0 (wraps to beginning)
      // We can only do this when size < capacity (checked by isFull())
  ...
  public static void demonstrateBuiltInCollections() {
    ...
    javaStack.push("Top");
    System.out.println("Stack: " + javaStack); // [Bottom, Middle, Top]
    System.out.println("Peek: " + javaStack.peek()); // Top (only view the top element)
    System.out.println(
        "Pop: " + javaStack.pop()); // [Top] (removes and returns the top element) now stack is
    System.out.println("After pop: " + javaStack); // [Bottom, Middle]

    // 2. DEQUE AS STACK (Recommended approach)
    // A deque (double-ended queue) can be used as a stack (or queue)
    System.out.println("\n📚 ArrayDeque as Stack (Recommended):");
    Deque<String> stackDeque = new ArrayDeque<>();
    stackDeque.push("First"); // Same as addFirst() - adds to the "top"
    stackDeque.push("Second"); // Same as addFirst() - adds to the "top"
    stackDeque.push("Third"); // Same as addFirst() - adds to the "top"
    System.out.println("Stack: " + stackDeque); // [Third, Second, First]
    System.out.println("Pop: " + stackDeque.pop()); // Same as removeFirst() - removes from "top"
    System.out.println("After pop: " + stackDeque); // [Second, First]
  ...
  /** INTERACTIVE STACK GAME Students can play this to understand stack operations better */
  ...
  /** INTERACTIVE QUEUE GAME Restaurant service simulation */
